package com.shinthunder.vertx.practice07.client;
...
import static com.shinthunder.vertx.practice07.server.MainServer.WEBSOCKET_PORT;
import static com.shinthunder.vertx.practice07.server.MainServer.HTTP_PORT;
...
public class ChatClient extends AbstractVerticle {
    ...
    private void handleUsername(String username) {
        ...
        vertx.createHttpClient().webSocket(WEBSOCKET_PORT, HOST, "/", webSocketAsyncResult -> {
    ...
    private void handleImageUploadFromChat(WebSocket webSocket, String username, String roomName, AtomicInteger
        ...
        readInputFromUserToExecuteBlocking(imagePath -> {
            try {
                ...
                client.post(HTTP_PORT, HOST, "/upload")
...
//                                System.out.println("    roomName            : " + roomName);
    ...
    private void downloadImage(String imagePath, WebSocket webSocket, String username, String roomName) {
        WebClient client = WebClient.create(vertx);
        client.get(HTTP_PORT, HOST, "/download/" + imagePath)
                .send(ar -> {
                    if (ar.succeeded()) {
